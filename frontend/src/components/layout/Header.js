            ...
            <nav className="navbar row">
                ...
                <div className="col-12 col-md-3 mt-4 mt-md-0 text-center">
                    <Link to="/services" style={{ textDecoration: 'none', color: 'white' }}>
                        <span id="cart" className="ml-3">Services</span>
                    </Link>

                    <Link to="/events" style={{ textDecoration: 'none', color: 'white' }}>
                        <span id="cart" className="ml-3">Events</span>
                    </Link>

                    <Link to="/blogspage" style={{ textDecoration: 'none', color: 'white' }}>
                        <span id="cart" className="ml-3">Blogs</span>
                    </Link>
