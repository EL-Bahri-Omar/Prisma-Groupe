          ...
          <div className="text-section">
            <div className="text-content">
              ...
              <p className="description">
                Prisma Lab est un leader dans le domaine de l'innovation et du conseil technologique. Depuis 2005, nous accompagnons nos clients dans la transformation digitale, l'optimisation des processus et la mise en œuvre de solutions technologiques de pointe. Notre mission est de créer un impact durable grâce à l'innovation.
              </p>
