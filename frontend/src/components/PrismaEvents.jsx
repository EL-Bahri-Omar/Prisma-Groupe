        ...
        <div className="explore-container">
          ...
          <div className="text-section">
            <div className="text-content">
              <h1>PRISMA EVENT</h1>
              <p className="website-link">WWW.PRISMAEvent.COM</p>
              <h2>Innovation et Conseil Technologique</h2>
              <p className="description">
                Prisma Event est un leader dans le domaine de l'innovation et du conseil technologique. Depuis 2005, nous accompagnons nos clients dans la transformation digitale, l'optimisation des processus et la mise en œuvre de solutions technologiques de pointe. Notre mission est de créer un impact durable grâce à l'innovation.
              </p>
