  ...
  return (
    <div className={`app-container ${sidebarOpen ? 'sidebar-open' : ''}`}>
      ...
      <div className="main-content">
        <div className="information-split-container">
          {/* Première div avec contenu texte et bg image */}
          <div className="information-left-section">
          ...
          {/* Deuxième div avec taglines et bg image différente */}
          <div className="information-right-section">
