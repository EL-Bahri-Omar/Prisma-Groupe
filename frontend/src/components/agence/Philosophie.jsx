  ...
  return (
    <div className={`app-container ${sidebarOpen ? 'sidebar-open' : ''}`}>
      ...
      <div className="main-content">
        <div className="philosophie-split-container">
          {/* Première div avec contenu texte */}
          <div className="philosophie-left-section">
          ...
          {/* Deuxième div avec citations ou valeurs */}
          <div className="philosophie-right-section">
