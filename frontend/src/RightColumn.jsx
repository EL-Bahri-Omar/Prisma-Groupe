    ...
    <div className="mask">
      <div className="col col-r">
        ...
        <div id="page14" className="full-page right-page">
          <img src="/src/assets/home/distribution.png" alt="Background" className="background-img" />
        </div>
        <div id="page12" className="full-page right-page">
          <img src="/src/assets/home/logistique.png" alt="Background" className="background-img" style={{ backgroundImage: 'url("/src/assets/home/studio1.png")'}}/>
        </div>
        <div id="page10" className="full-page right-page">
          <img src="/src/assets/home/studio.png" alt="Background" className="background-img" />
        </div>
        ...
        <div id="page6" className="full-page right-page">
          <img src="/src/assets/home/espace-deco.png" alt="Background" className="background-img" />
        </div>
        ...
        <div id="page2" className="full-page right-page">
          <img src="/src/assets/home/groupe.png" alt="Background" className="background-img" style={{ backgroundColor: '#014351'}}/>
        </div>
      </div>
    </div>
  );
